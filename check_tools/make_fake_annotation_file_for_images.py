...
with open("/data/pcl/proj/object-centric-ovd/datasets/5images/fake_coco_annotation.json", "w") as f:
    json.dump(coco_annotation, f)

# read
with open("/data/pcl/proj/object-centric-ovd/datasets/5images/fake_coco_annotation.json", "r") as f:
    data = json.load(f)
print("--------------------------------------------------")
